      ...
      <section className="bg-surface py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl">
            Service complet à domicile dans les zones desservies au Québec, par une équipe spécialisée.
          </p>
        </div>
      </section>
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Service de {s.verb.toLowerCase()} disponible dans les zones desservies; confirmez votre ville avant le rendez-vous.
              </p>
