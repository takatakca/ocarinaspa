...
export const Route = createFileRoute("/en")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional mobile hot tub and spa service in supported Quebec areas: repair, maintenance, installation, opening and closing. Call 819-913-7727 to confirm availability." },
      { property: "og:title", content: "Ocarina Spa — Hot tub & spa service in Quebec" },
      { property: "og:description", content: "Mobile hot tub repair and maintenance in supported Quebec areas." },
    ...
    <Layout>
      <section className="bg-surface">
        <div className="container mx-auto px-4 py-16 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <p className="text-brand font-semibold uppercase text-sm tracking-wide">Selected Quebec service areas</p>
            ...
            <p className="mt-5 text-muted-foreground">
              Ocarina Spa offers professional mobile service for hot tubs, spas and pools in supported Quebec areas — repair, maintenance, installation, opening and closing. Call to confirm availability for your address.
            </p>
            ...
            <ul className="mt-6 grid sm:grid-cols-2 gap-2 text-sm">
              {["Hot tub repair", "Hot tub maintenance", "Spa service", "Pool opening & closing", "Pool cleaning", "Major brands"].map((b) => (
          ...
          <img src={technician} alt="Ocarina Spa technician servicing an outdoor hot tub" className="rounded-2xl shadow-2xl" />
        </div>
      </section>
